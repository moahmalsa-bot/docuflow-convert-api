...
def create_app() -> FastAPI:
    ...
    # CORS is registered BEFORE any router. Explicit methods + exposed
    # download headers so browsers accept both the preflight AND the real
    # multipart POST / file download responses. allow_credentials stays
    # False — it must never be True together with allow_origins=["*"].
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["*"],
